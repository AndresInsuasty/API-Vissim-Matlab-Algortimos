...
<sc version="201602" id="8" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="2279914249">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="112" defaultSignalSequence="3">
      <defaultDurations>
    ...
    <sg id="2" name="4A" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
